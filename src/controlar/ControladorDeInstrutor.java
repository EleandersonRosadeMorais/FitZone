...
public class ControladorDeInstrutor {
    ...
    public boolean inserir(Instrutor instrutor) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao inserir instrutor: " + e.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
        } finally {
    ...
    public boolean alterar(Instrutor instrutor) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao atualizar instrutor: " + e.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
        } finally {
            gerenciador.fecharConexao(comando);
        }
